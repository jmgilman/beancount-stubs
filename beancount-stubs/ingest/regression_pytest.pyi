...
def assertStringEqualNoWS(actual_string: str, expected_string: str) -> None: ...
def compare_contents_or_generate(
    actual_string: str, expect_fn: str, generate: bool
) -> None: ...

class ImporterTestBase:
    def test_identify(self, importer: ImporterProtocol, file: FileMemo) -> None: ...
    def test_extract(
        self, importer: ImporterProtocol, file: FileMemo, pytestconfig: pytest.Config
    ) -> None: ...
    def test_file_date(
        self, importer: ImporterProtocol, file: FileMemo, pytestconfig: pytest.Config
    ) -> None: ...
