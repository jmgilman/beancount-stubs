...
class Open:
    ...
    def _replace(self: Open, /, **kwargs) -> Open: ...
...
class Close:
    ...
    def _replace(self: Close, /, **kwargs) -> Close: ...
...
class Commodity:
    ...
    def _replace(self: Commodity, /, **kwargs) -> Commodity: ...
...
class Pad:
    ...
    def _replace(self: Pad, /, **kwargs) -> Pad: ...
...
class Balance:
    ...
    def _replace(self: Balance, /, **kwargs) -> Balance: ...
...
class Posting:
    ...
    def _replace(self: Posting, /, **kwargs) -> Posting: ...
...
class TxnPosting:
    ...
    def _replace(self: TxnPosting, /, **kwargs) -> TxnPosting: ...
...
class Note:
    ...
    def _replace(self: Note, /, **kwargs) -> Note: ...
...
class Event:
    ...
    def _replace(self: Event, /, **kwargs) -> Event: ...
...
class Query:
    ...
    def _replace(self: Query, /, **kwargs) -> Query: ...
...
class Price:
    ...
    def _replace(self: Price, /, **kwargs) -> Price: ...
...
class Document:
    ...
    def _replace(self: Document, /, **kwargs) -> Document: ...
...
class Custom:
    ...
    def _replace(self: Custom, /, **kwargs) -> Custom: ...
